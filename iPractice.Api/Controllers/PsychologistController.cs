...
public class PsychologistController : ControllerBase
{
    ...
    public async Task<ActionResult> CreateAvailability([FromRoute] long psychologistId,
    ...
    public async Task<ActionResult<Availability>> UpdateAvailability([FromRoute] long psychologistId,
        [FromRoute] long availabilityId, [FromBody] Availability availability)
    {
        throw new NotImplementedException();
    }
}
